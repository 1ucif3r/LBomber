...
"
    ...
    #toilet -f ivrit 'LBOMBER' | boxes -d cat -a hc -p h8 | lolcat
    else
    cowsay 'LBOMBER' | lolcat
    fi
...
set_alias(){
	...
	if grep -q "bomb" bash.bashrc; then
	    ...
	    echo 'alias bomb="cd;cd scripts;cd Social-Attacks;cd LBomber;bash LBomber.sh";' >> bash.bashrc
	    echo 'clear' >> bash.bashrc
	    echo 'PS1="\033[1;91mRoot[\033[1;93m\W\033[1;91m]:-\033[1;36m"' >> bash.bashrc
	    alias bomb="cd;cd scripts;cd Social-Attacks;cd LBomber;bash LBomber.sh";
	    clear
        fi
    else
	    ...
	    clear
            ...
            echo ' ' >> /root/.bashrc
	    echo 'alias bomb="cd;cd scripts;cd Social-Attacks;cd LBomber;bash LBomber.sh";' >> /root/.bashrc
	    alias bomb="cd;cd scripts;cd Social-Attacks;cd LBomber;bash LBomber.sh";
        fi	    
    fi
}
...
if [ -f .update ];then
    ...
    install_deps
    echo 'This Script Was Made By Hritik(1ucif3r)' > .update
